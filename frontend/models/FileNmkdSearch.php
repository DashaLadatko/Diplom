...
class FileNmkdSearch extends FileNmkd
{
    ...
    {
        return [
            [['id', 'discipline_id', 'component_nmkd_id', 'user_id', 'protocol_chair', 'protocol_fuculty', 'protocol_university', 'total', 'created_by', 'updated_by'], 'integer'],
            [['name', 'signature', 'comment', 'created_at', 'updated_at'], 'safe'],
        ];
    }
